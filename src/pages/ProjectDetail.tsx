          ...
          <div className="terminal-body min-h-[500px] overflow-y-auto">
            ...
            <div className="space-y-6">
              <div>
                ...
                {/* Local tab state */}
                {(() => {
                  const [detailTab, setDetailTab] = React.useState<'Overview' | 'Links' | 'Docs' | 'Mentors'>('Overview');
            ...
            {/* Apply Section (disabled while applications are closed)
            <div className="border-t border-terminal-dim pt-4 flex flex-col md:flex-row md:justify-between items-start md:items-center gap-4">
              ...
              <div>
                <span className="text-terminal-dim">Application buttons are temporarily disabled.</span>
              </div>
            </div>
            */}
