...
const Timeline = () => {
  ...
  return (
    <div className="min-h-screen bg-terminal/95 flex flex-col items-center p-2 sm:p-4">
      <div className="max-w-7xl w-full mx-auto my-4 sm:my-8">
        {/* Header Section */}
        <div className="mb-6 sm:mb-8 px-2 sm:px-0">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h1 className="text-2xl sm:text-4xl font-bold text-terminal-text">Projects Timeline</h1>
        ...
        {seasonGroups.length === 0 ? (
          <div className="terminal-window max-w-6xl w-full mx-auto">
            <TerminalHeader title="Timeline" />
            <div className="terminal-body min-h-[500px] flex items-center justify-center">
